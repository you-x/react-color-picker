...
export const Controls: React.FC<Props> = ({
  ...
  const [openComparibles, setOpenComparibles] = useState<boolean>(false);
  const [openInputType, setOpenInputType] = useState<boolean>(false);
  const noTools =
...
type InputTypeDropdownProps = {
  ...
  setOpenInputType: React.Dispatch<React.SetStateAction<boolean>>;
};

const InputTypeDropdown: React.FC<InputTypeDropdownProps> = ({
  openInputType,
  setOpenInputType,
}) => {
