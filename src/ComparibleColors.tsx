...
export const ComparibleColors: React.FC<Props> = ({ openComparibles }) => {
  ...
  return (
    ...
    >
      <div
        style={{ paddingTop: 11, display: openComparibles ? "" : "none" }}
        className="ps-rl"
      >
        <div
          style={{
        ...
        <div className="df" style={{ borderRadius: 5, overflow: "hidden" }}>
          {analogous?.map((c, key) => (
            <div
              key={key}
        ...
        <div className="df jfe" style={{ borderRadius: 5, overflow: "hidden" }}>
