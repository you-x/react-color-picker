...
export const LinearIcon: React.FC<Props> = ({ color }) => {
...
export const RadialIcon: React.FC<Props> = ({ color }) => {
  const col = color || "#323136";
  const styles = {
    fill: "none",
    stroke: col,
...
export const SlidersIcon: React.FC<Props> = ({ color }) => {
  const col = color || "#323136";
  const style1 = {
    fill: "none",
    stroke: col,
...
export const InputsIcon: React.FC<Props> = ({ color }) => {
  const col = color || "#323136";
  const style1 = {
    fill: "none",
    stroke: col,
...
export const PaletteIcon: React.FC<Props> = ({ color }) => {
  const col = color || "#323136";
...
export const DegreesIcon: React.FC<Props> = ({ color }) => {
  const col = color || "#323136";
...
export const DropperIcon: React.FC<Props> = ({ color }) => {
  const col = color || "#323136";
